...
| OM-140 | `codex/om140-application-contracts` | `F:\\claude\\projects\\OpenManic\\.agents\\om140-application-contracts` | _recorded at activation commit_ | `crates/openmanic-application/**` | Application crate and public contracts exclusively transferred; no storage/platform/UI crate, root manifest, or schema change | Active; Phase 1 task checks pending handoff |
