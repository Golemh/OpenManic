...
| OM-282 | `codex/om282-timeline-kernel` | `F:\\claude\\projects\\OpenManic\\.agents\\om282-timeline-kernel` | `47c3144` | `crates/openmanic-ui-egui/src/timeline/{mod.rs,paint.rs,interaction.rs}` | Serialized extension of OM-281's timeline module; no application, storage, platform, root-manifest, or domain path is transferred | Active; Phase 2 verification deferred to the one phase gate |
