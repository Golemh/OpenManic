...
| OM-110 | `codex/om110-focus-domain` | `F:\\claude\\projects\\OpenManic\\.agents\\om110-focus-domain` | _recorded at activation commit_ | `crates/openmanic-domain/src/focus.rs` | Focus module exclusively transferred; no shared exports or dependencies | Active; may run parallel with OM-120/130 |
| OM-120 | `codex/om120-schedule-domain` | `F:\\claude\\projects\\OpenManic\\.agents\\om120-schedule-domain` | _recorded at activation commit_ | `crates/openmanic-domain/src/schedule.rs` | Schedule module exclusively transferred; no shared exports or dependencies | Active; may run parallel with OM-110/130 |
| OM-130 | `codex/om130-document-domain` | `F:\\claude\\projects\\OpenManic\\.agents\\om130-document-domain` | _recorded at activation commit_ | `crates/openmanic-domain/src/documents.rs` | Document-value module exclusively transferred; no shared exports or dependencies | Active; may run parallel with OM-110/120 |
