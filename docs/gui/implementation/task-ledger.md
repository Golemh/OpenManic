...
| OM-291 | `codex/om291-timeline-renderer` | `F:\\claude\\projects\\OpenManic\\.agents\\om291-timeline-renderer` | `763e2f5` | `crates/openmanic-ui-egui/src/timeline/{mod.rs,renderer.rs,detail.rs}` | Serialized renderer/detail extension after OM-282 and OM-290; no application, storage, platform, root-manifest, domain, or Today-controller path is transferred | Active; Phase 2 verification deferred to the one phase gate |
| OM-292 | `codex/om292-usage-widget` | `F:\\claude\\projects\\OpenManic\\.agents\\om292-usage-widget` | `763e2f5` | `crates/openmanic-ui-egui/src/usage.rs` | The primary predeclared the private module; no shared UI, application, storage, platform, root-manifest, or domain path is transferred | Active; Phase 2 verification deferred to the one phase gate |
| OM-293 | `codex/om293-distribution-widget` | `F:\\claude\\projects\\OpenManic\\.agents\\om293-distribution-widget` | `763e2f5` | `crates/openmanic-ui-egui/src/distribution.rs` | The primary predeclared the private module; queued behind an available author slot; no shared UI, application, storage, platform, root-manifest, or domain path is transferred | Queued; Phase 2 verification deferred to the one phase gate |
...
| OM-296 | `codex/om296-windows-tray-instance` | `F:\\claude\\projects\\OpenManic\\.agents\\om296-windows-tray-instance` | `1df90e4` | `crates/openmanic-platform/src/{lib.rs,windows_control.rs,windows_tray.rs,windows_single_instance.rs}` | The primary enabled the tray/pipe/security namespaces; data-root lock remains the accepted OM-295 bootstrap boundary and final composition is OM-299-owned | Active; Phase 2 verification deferred to the one phase gate |
