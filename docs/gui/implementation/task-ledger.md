...
| OM-270 | `codex/om270-ui-shell` | `F:\\claude\\projects\\OpenManic\\.agents\\om270-ui-shell` | `450fe2799452cd63ff7d250da56a9eda85961303` | `crates/openmanic-ui-egui/src/{lib.rs,app.rs,controller.rs,model.rs,reducer.rs,repaint.rs,shell.rs}` | No storage/platform dependency or application-contract change is transferred | Active in parallel with OM-200; dispatcher waits on final runtime lane semantics |
