...
| OM-281 | `codex/om281-timeline-geometry` | `F:\\claude\\projects\\OpenManic\\.agents\\om281-timeline-geometry` | `02b80c5` | `crates/openmanic-ui-egui/src/{lib.rs,timeline/{mod.rs,geometry.rs,hit_test.rs,ticks.rs}}` | Serialized UI timeline-geometry allocation after OM-280; no application, storage, platform, root-manifest, or domain path is transferred | Active; Phase 2 verification deferred to the one phase gate |
...
| OM-250 | `codex/om250-windows-identity` | `F:\\claude\\projects\\OpenManic\\.agents\\om250-windows-identity` | `f9457f9` | `crates/openmanic-platform/src/windows_identity.rs` | The primary reserved the private module and required cached Windows namespaces; control-loop composition remains OM-299-owned | Active; Phase 2 verification deferred to the one phase gate |
| OM-260 | `codex/om260-windows-lifecycle` | `F:\\claude\\projects\\OpenManic\\.agents\\om260-windows-lifecycle` | `f9457f9` | `crates/openmanic-platform/src/windows_lifecycle.rs` | The primary reserved the private module and required cached Windows namespaces; control-loop composition remains OM-299-owned | Active; Phase 2 verification deferred to the one phase gate |
